...
function genererPage(q, client, isDemo) {
  ...
  var css = [
    ...
    '.glow2{position:fixed;bottom:-20%;right:-20%;width:60%;height:60%;background:radial-gradient(ellipse,#4d553d22 0%,transparent 65%);pointer-events:none;z-index:0;animation:gm 10s ease-in-out infinite reverse;}',
    ...
    '.nb.sel{border-color:' + accent + ';color:' + accent + ';box-shadow:0 0 14px ' + accent + '44;}',
